    ...
    function scanRemovableGames(noDemo = false) {
        ...
        rows.forEach(row => {
            ...
            if (removeLink) {
                ...
                const isDemo = (cells[1].innerText.search(/\b(demo|prologue|trial|episode|alpha|beta|sample|демо|пролог|эпизод|альфа|бета|тест|пробная)\b|(体験|試用|デモ|ベータ|アルファ|序章|试玩|試玩|体验|體驗|演示|前編|前篇|체험|프롤로그|에피소드|알파|베타)(版|판)?|お試し/i) > -1) || noDemo; // /(\s|\()(demo|prologue)(?![a-z])/i
